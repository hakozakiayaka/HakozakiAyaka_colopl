...
CTexture2D *CRanking::m_pTexture2D = NULL;
CScene3D *CRanking::m_pScene3D = NULL;
...
HRESULT CRanking::Init(void)
{
	...
	CUI::Load(CManager::MODE_RANKING);	//  Uiの読み込み
	...
	CScore::Create(D3DXVECTOR3(750.0f, 120.0f, 0.0f), CScore::RANKING_SCORE);
	CScore::Create(D3DXVECTOR3(100, 600, 0), CScore::GAME_SCORE);
	return S_OK;
}
//==============================================
//終了
...
void CRanking::Update(void)
{
	...
	{// フェードしていない状態
		...
		{// キーボード（ENTER）を入力したら
			CFade::Create(CManager::MODE_TITLE, CFade::FADE_OUT, 3);
...
// テキスト読み込み
//=============================================================================
void CRanking::ObjectLoad(void)
{
	FILE *pFile;
	char read[128];										//	読み込む文字列
	char *txstName[OBJTYPE_MAX][128] = {};	//	読み込むテキストのファイル

	txstName[OBJTYPE_ITEM][0] = "data/TEXT/RANKING_MAP/ItemSet.txt";		//	ステージ1のアイテム
	txstName[OBJTYPE_BLOCK][0] = "data/TEXT/RANKING_MAP/BlockSet.txt";		//	ステージ1ブロック
	txstName[OBJTYPE_3DPORI][0] = "data/TEXT/RANKING_MAP/3DPorSet.txt";		//	ステージ1Dポリゴンビルボード
	txstName[OBJTYPE_FLOOR][0] = "data/TEXT/RANKING_MAP/FloorSet.txt";		//	ステージ1Dポリゴン床
	txstName[OBJTYPE_WALL][0] = "data/TEXT/RANKING_MAP/WallSet.txt";		//	ステージ1Dポリゴン壁
	txstName[OBJTYPE_ENEMY][0] = "data/TEXT/RANKING_MAP/EnemySet.txt";		//	ステージ1Dポリゴン敵
